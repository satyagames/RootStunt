...
//			_sharedOBJ.setData("artifactsFoundArray", CoreData.Instance.artifactsFoundArray)
		...
		public function waitForMochiItems():void {
			...
			//MochiServices.connect("773bf26500fbcf4c", root);
			//MochiAd.showPreGameAd({clip:root, id:"773bf26500fbcf4c", res:"640x480",ad_finished:startGame});
		...
		private var MENU_ITEM_0:String="www.zopy.in";
